...
const surveytype = () => {
  ...
  function calculate(){
          ...
          if (surveytype == 'RELOCATION') {
              ...
              excess_lot_detail.innerHTML = '15,000  x  ' + get_excess_area(r_lot_area) + '  =  ';
              ...
              excess_lot_detail.innerHTML = '15,000  x  ' + get_excess_area(s_lot_area) + '  =  ';
              ...
              if (check(num_consolidated) && check(c_get_total_ex())) {
                    ...
                    excess_lot_detail.innerHTML = '15,000  x  ' + c_total_ex_lot + '  =  ';
  ...
  function get_excess_area_price(val){ // LOT AREA PRICE
    return  val * 15000; //1,500 per Hectare
  }
